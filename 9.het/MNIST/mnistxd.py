...
def main(_):
  ...
  #A v2-es verziot kell mar itt hasznalni
  ...
  print("-- A sajat kezi szamom felismerese, mutatom a szamot, a tovabblepeshez csukd be az ablakat")

  img = readimg()
  image = img.eval()
  image = image.reshape(28*28)
  #image = image.set_shape([28, 28, 4])  

  #img = mnist.test.images[45]
  #image = img
