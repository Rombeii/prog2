 ...
 * @version 0.0.1
 */
public class MandelbrotHalmaző extends java.awt.Frame implements Runnable {
     ...
     * <code>MandelbrotHalmaző</code> objektumot.
     *
     ...
     */
    public MandelbrotHalmaző(double a, double b, double c, double d,
            ...
            public void keyPressed(java.awt.event.KeyEvent e) {
                ...
                // Az 'n' gomb benyomásával pontosabb számítást végzünk.
                    ...
                    if(számításFut == false) {
                        MandelbrotHalmaző.this.iterációsHatár += 256;
                        // A számítás újra indul:
                        számításFut = true;
                        new Thread(MandelbrotHalmaző.this).start();
                    }
                ...
                // határt, mint az 'n' használata esetén
                    ...
                    if(számításFut == false) {
                        MandelbrotHalmaző.this.iterációsHatár += 10*256;
                        // A számítás újra indul:
                        számításFut = true;
                        new Thread(MandelbrotHalmaző.this).start();
                    }
    ...
    public static void main(String[] args) {
        ...
        new MandelbrotHalmaző(-2.0, .7, -1.35, 1.35, 600, 255);
    }
}                
